...
(() => {
  ...
  const h = (n, s) => {
    for (const e in s) ls(n, e, { get: s[e], enumerable: !0 });
  };
  const Bt = {};
  ...
  const os = "a[href], button, input, [tabindex]";

  function Kt(n) {
    const s = n.querySelectorAll(os);
  ...
  function b(n) {
    const s = typeof n == "string" ? n.charCodeAt(0) : n;
  ...
  function Zt(n) {
    ...
    for (const t of e) if (be[t]) return be[t];
    return be.en;
  }
  function Xt(n, s = {}, e) {
    if (!n) return "";
    ...
    for (const [r, i] of Object.entries(s)) {
      const a = typeof i == "number" && e ? new Intl.NumberFormat(e).format(i) : String(i);
  ...
  const De = class {
    ...
    announce(s, e = "polite") {
      ...
      const t = e === "polite" ? this.politeIndex : this.assertiveIndex,
        r = this.regions[e][t];

      e === "polite"
        ? (this.politeIndex = t === 0 ? 1 : 0)
        : (this.assertiveIndex = t === 0 ? 1 : 0);
      const i = e === "polite" ? this.politeIndex : this.assertiveIndex;
    ...
    clear() {
      if (this.regions) {
        this.clearTimeoutId && (clearTimeout(this.clearTimeoutId), (this.clearTimeoutId = null));
        for (const s of ["polite", "assertive"])
          for (const e of this.regions[s]) e.textContent = "";
      }
    }
    destroy() {
  ...
  try {
    if (document?.currentScript && document.currentScript.tagName.toUpperCase() === "SCRIPT") {
      const n = new URL(document.currentScript.src).pathname.match(
  ...
  const Te = class {
    ...
    getInputs(s = null) {
      const e = this.componentsByType.input || [];

      return s ? e.filter((t) => t.capabilities?.[s]) : e;
    }
    getResults(s = null) {
      const e = this.componentsByType.results || [];

      return s ? e.filter((t) => t.capabilities?.[s]) : e;
    }
    getSummaries(s = null) {
      const e = this.componentsByType.summary || [];

      return s ? e.filter((t) => t.capabilities?.[s]) : e;
    }
    getFilters(s = null) {
      const e = this.componentsByType.filter || [];

      return s ? e.filter((t) => t.capabilities?.[s]) : e;
    }
    getSorts(s = null) {
      const e = this.componentsByType.sort || [];
    ...
    focusNextResults(s) {
      const e = this.getResults("keyboardNavigation"),
        t = $t(s, e);
    ...
    focusPreviousInput(s) {
      const e = this.getInputs("keyboardNavigation"),
        t = Pe(s, e);
    ...
    focusInputAndType(s, e) {
      const t = this.getInputs("keyboardNavigation"),
        r = Pe(s, t),
    ...
    on(s, e, t = null) {
      if (!this.__hooks__[s]) {
        const r = Object.keys(this.__hooks__).join(", ");
      ...
      if (t) {
        const r = this.__hooks__[s].findIndex((i) => typeof i == "object" && i.owner === t);
...
`)
  ...
  let Pt = class {
      ...
      detectBundlePath() {
        try {
          if (
            ...
            const s = new URL(document.currentScript.src).pathname.match(
              /^(.*\/)(?:pagefind[-_])?.*\.js.*$/
            );
      ...
      getInstance(s = "default", e = {}) {
        const t = this.instances.get(s);

        if (t) return t;
        const r = { ...this.defaultOptions, ...e },
          i = new Te(s, r);
  ...
  var ye = (n) =>
    ...
    es = {
      ...
      and: (n, ...s) => {
        ...
        for (const t of s) if (((e = m(t, n)), !ye(e))) return e;
        return e;
      },
      or: (n, ...s) => {
        let e = !1;
      ...
      truncate: (n, ...s) => {
        const e = T(s, 2, "truncate");

        if (e) return e;
        const t = String(m(s[0], n)),
          r = Number(m(s[1], n)),
...
`
        ...
        o = (u = []) => {
          ...
          e: for (; e < s.length; ) {
            for (const p of u) if (r(p)) break e;
            if (s[e] === "\\" && r("\\{{")) {
  ...
  var f = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._initialized = !0;
      const e = this.getAttribute("instance") || "default",
        t = Ce();
  ...
  var Re = class extends f {
    ...
    register(s) {
      ...
      const e = this.getAttribute("bundle-path");

      e && (s.options.bundlePath = e);
      const t = this.getAttribute("base-url");

      t && (s.pagefindOptions.baseUrl = t);
      const r = this.getAttribute("excerpt-length");

      r && (s.pagefindOptions.excerptLength = parseInt(r, 10));
      const i = this.getAttribute("lang");

      i && s.setLanguage(i);
      const a = this.getAttribute("meta-cache-tag");

      a && (s.pagefindOptions.metaCacheTag = a);
      const l = this.getAttribute("highlight-param");
  ...
  var Ea = (n = 100) => new Promise((s) => setTimeout(s, n)),
    ke = class extends f {
      ...
      render() {
        this.innerHTML = "";
        const e = this.instance.generateId("pfmod-input"),
        ...
        const a = document.createElement("search");
        ...
        const o = this.instance.generateId("pf-input-hint"),
      ...
      setupEventHandlers() {
        !this.inputEl ||
          ...
          this.inputEl.addEventListener("focus", () => {
            ...
            const e = this.instance?.translate("keyboard_navigate") || "navigate",
      ...
      (e.registerSummary(this),
        ...
        e.on(
          ...
          (t) => {
            ...
            const a = i === 0 ? "zero_results" : i === 1 ? "one_result" : "many_results",
        ...
        e.on(
          ...
          () => {
            ...
            const t = e.translate("searching", { SEARCH_TERM: this.term });
  ...
  <div class="pf-result-card">
    ...
    Dt = class {
      ...
      setupObserver() {
        if (this.result !== null || this.observer !== null || !this.placeholderNodes?.length)
          return;
        const s = { root: this.intersectionEl, rootMargin: "50px", threshold: 0.01 };
      ...
      async load() {
        if (this.placeholderNodes?.length && !(this.result !== null || this.loading)) {
          ...
          try {
            ...
            const s = this.resultFn(this.result, {
            ...
            for (rs(e, this.index); this.placeholderNodes.length > 1; ) {
              const r = this.placeholderNodes.pop();

              r instanceof Element && r.remove();
            }
            const t = this.placeholderNodes[0];
    ...
    Se = class extends f {
      ...
      buildTemplateData(e, t) {
        const r = t.showSubResults ? this.instance.getDisplaySubResults(e, t.maxSubResults) : [];
      ...
      getResultRenderer() {
        if (this.resultTemplate) {
          const e = this.resultTemplate;

          return (t, r) => e(t);
        }
        if (this.compiledResultTemplate) {
          const e = this.compiledResultTemplate;

          return (t, r) => {
            const i = this.buildTemplateData(t, r);

            return e(i);
          };
        }
        return (e, t) => {
          const r = this.buildTemplateData(e, t);
      ...
      render() {
        ...
        const t = this.instance?.translate("results_label") || "Search results";
      ...
      appendResults(e) {
        if (this.containerEl) for (const t of e) this.containerEl.appendChild(t);
      }
      register(e) {
        (e.registerResults(this, { keyboardNavigation: !0, announcements: !0 }),
          e.on(
            ...
            (t) => {
              ...
              for (const c of this.results) c.cleanup();
              ((this.containerEl.innerHTML = ""),
                this.containerEl.setAttribute("aria-busy", "false"),
                (this.intersectionEl = zt(this.containerEl)),
                (this.selectedIndex = -1),
                (this.selectedAnchor = null));
              const i = this.maxResults > 0 ? r.results.slice(0, this.maxResults) : r.results,
                a = i.length,
                l = e.searchTerm;

              if (l) {
                const c = a === 0 ? "zero_results" : a === 1 ? "one_result" : "many_results",
              ...
              const o = this.getResultRenderer();

              this.results = i.map((c, u) => {
                const d = ss(this.getPlaceholder());
      ...
      findNeighborAnchor(e, t) {
        ...
        const r = document.createTreeWalker(this.containerEl, NodeFilter.SHOW_ELEMENT, {
          acceptNode: (l) =>
            l.tagName === "A" ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP,
        });

        r.currentNode = e;
        const i = t > 0 ? r.nextNode() : r.previousNode();

        if (!i || !(i instanceof HTMLAnchorElement)) return null;
        const a = this.resultIndexForNode(i);
      ...
      resultIndexForNode(e) {
        ...
        const r = t.getAttribute("data-pf-result-index");
        ...
        this.containerEl &&
          (this.containerEl.addEventListener("keydown", (e) => {
            ...
            if (t)
              if (e.key === "ArrowDown") {
                e.preventDefault();
                const r = this.findNeighborAnchor(t, 1);
                ...
                if (r)
                  ...
                  const a = this.resultIndexForNode(t) + 1;

                  if (a > 0 && a < this.results.length) {
                    const l = this.results[a];
          ...
          this.containerEl.addEventListener("focusin", (e) => {
            ...
            const r = this.instance?.translate("keyboard_navigate") || "navigate",
      ...
      scrollToCenter(e, t = !1) {
        const r = this.intersectionEl || zt(e);
      ...
      cleanup() {
        ...
        for (const e of this.results) e.cleanup();
  ...
  var Ne = class extends f {
    ...
    init() {
      if (
        ...
        const e = this.getAttribute("sort");
    ...
    hasStructureChanged() {
      ...
      const e = new Set(Object.keys(this.totalFilters)),
        t = new Set(this.groupElements.keys());

      if (e.size !== t.size) return !0;
      for (const r of e) if (!t.has(r)) return !0;
      for (const [r, i] of Object.entries(this.totalFilters)) {
        const a = new Set(Object.keys(i));

        for (const l of a) if (!this.filterElements.has(`${r}:${l}`)) return !0;
      }
      return !1;
    }
    handleFiltersUpdate() {
    ...
    renderFilters() {
      ...
      const e = Object.keys(this.totalFilters);

      for (const t of e) {
        const r = this.totalFilters[t],
    ...
    updateFilters() {
      for (const [e, t] of this.filterElements) {
        const r = e.indexOf(":"),
          i = e.slice(0, r),
          a = e.slice(r + 1),
      ...
      for (const [e, t] of this.groupElements) {
        const r = this.selectedFilters[e]?.size || 0;
        ...
        const i = this.groupVisibleCounts.get(e) ?? 0;
    ...
    renderCheckbox(e, t, r, i, a, l) {
      const o = this.instance.generateId(`pf-filter-${t}-${r}`),
      ...
      ((u.type = "checkbox"),
        ...
        c.appendChild(u));
      const d = document.createTextNode(r);
    ...
    handleCheckboxChange(e, t, r) {
      ...
      const i = this.groupElements.get(e);

      if (i?.selectedCountSpan) {
        const l = this.selectedFilters[e].size;
      ...
      const a = Array.from(this.selectedFilters[e]);

      if (a.length === 0) {
        delete this.selectedFilters[e];
        const l = {};

        for (const [o, c] of Object.entries(this.selectedFilters)) l[o] = Array.from(c);
  ...
  var Me = class extends f {
    ...
    sortValues(e) {
      ...
      switch (this.sortOption) {
        ...
        case "count-desc":
          t.sort((r, i) => {
            const a = this.availableFilters[r] ?? this.totalFilters[r] ?? 0;
    ...
    render() {
      this.innerHTML = "";
      const e = this.ensureId("pf-dropdown"),
        t = `${e}-trigger`,
        r = `${e}-menu`;
    ...
    open() {
      ...
      if (
        ...
        const i = this.activeIndex >= 0 ? this.activeIndex : 0;
      ...
      switch (e.key) {
        ...
        case " ":
          if (
            ...
            const t = this.optionElements[this.activeIndex];
    ...
    handleTypeAhead(e) {
      ...
      const t = this.optionElements.findIndex(({ value: r }) =>
    ...
    updateOptions() {
      ...
      (this.wrapperEl?.removeAttribute("data-pf-hidden"),
        ...
        (this.optionElements = []),
        (this.focusedOptionEl = null));
      const r = this.id || this.ensureId("pf-dropdown");

      (t.forEach((i, a) => {
        const l = this.availableFilters?.[i] ?? 0,
    ...
    toggleOption(e) {
      const t = this.selectedValues.has(e);
      ...
      const r = this.selectedValues.has(e);

      if (r !== t) {
        const i = r ? "selected" : "deselected";
    ...
    dispatchFilterChange() {
      ...
      const e = Array.from(this.selectedValues);
    ...
    updateBadge() {
      ...
      const e = this.selectedValues.size;

      if (e > 0) {
        ((this.badgeEl.textContent = String(e)), this.badgeEl.removeAttribute("data-pf-hidden"));
        const t = this.getAttribute("label") || this.filterName || "",
    ...
    updateOptionStates() {
      for (const { el: e, value: t } of this.optionElements) {
        const r = this.selectedValues.has(t);
  ...
  var Oe = class extends f {
    ...
    render() {
      const e = this.children.length > 0,
        t = e ? Array.from(this.children) : null;

      this.innerHTML = "";
      const r = this.id || this.instance.generateId("pagefind-modal"),
      ...
      if (
        ...
        const a = this.getAttribute("instance"),
        ...
        const c = document.createElement("pagefind-modal-body"),
        ...
        const _ = document.createElement("pagefind-modal-footer"),
    ...
    open() {
      ...
      const e = this.instance?.translate("keyboard_close") || "close";

      (this.instance?.registerShortcut({ label: "esc", description: e }, this),
        requestAnimationFrame(() => {
          const r = this.querySelector("pagefind-input");
    ...
    handleClose() {
      ...
      const t = (this.instance?.getUtilities("modal-trigger") || [])[0];
  ...
  var He = class extends f {
    ...
    openModal() {
      const t = (this.instance?.getUtilities("modal") || [])[0];
    ...
    handleModalClose() {
      this.buttonEl &&
        (this.buttonEl.setAttribute("aria-expanded", "false"), this.buttonEl.focus());
    }
    register(e) {
    ...
    init() {
      ...
      ((this.closeBtn = document.createElement("button")),
        ...
        this.closeBtn.addEventListener("click", () => {
          const t = this.closest("pagefind-modal");
    ...
    render() {
      ((this.innerHTML = ""),
        this.instance?.direction === "rtl"
          ? this.setAttribute("dir", "rtl")
          : this.removeAttribute("dir"));
      const s = this.instance?.getActiveShortcuts() || [];
  ...
  <p class="pf-searchbox-result-excerpt pf-skeleton pf-skeleton-excerpt"></p>
    ...
    jt = class {
      ...
      setupObserver() {
        ...
        const s = { root: this.intersectionRoot, rootMargin: "50px", threshold: 0.01 };
      ...
      async load() {
        if (!(this.data !== null || this.loading)) {
          ...
          try {
            ...
            const s = this.renderFn(this.data),
              e = Ke(s);

            if (e.length > 0 && this.placeholderEl.parentNode) {
              const t = e.find((r) => r instanceof Element);
    ...
    Fe = class extends f {
      ...
      render() {
        ...
        const t = this.instance.generateId("pf-sb-input"),
        ...
        const a = this.instance?.translate("results_label") || "Search results";
      ...
      setupEventHandlers() {
        !this.inputEl ||
          ...
          this.resultsEl.addEventListener("mousemove", (e) => {
            ...
            if (t) {
              const r = this.getResultAndOffsetFromElement(t);
      ...
      moveSelection(e) {
        ...
        if (e < 0) {
          ...
          const c = this.results[o];

          if (!c || !c.data) return;
          const u = this.getOptionsForResult(c);
        ...
        const i = this.getOptionsForResult(r);
      ...
      handleResultLoaded() {
        ...
        for (; this.pendingNavigation !== 0; )
          if (e > 0) {
            const i = this.results[t];

            if (i?.data) {
              const o = this.getOptionsForResult(i);
            ...
            if (a?.data) {
              const l = this.getOptionsForResult(a);
      ...
      updateSelectionUI(e = !1) {
        ...
        this.selectedEl &&
          ...
          (this.selectedEl = null));
        const t = this.activeIndex >= 0 ? this.results[this.activeIndex] : null,
      ...
      getResultAndOffsetFromElement(e) {
        const t = e.closest("[data-pf-result-index]");

        if (!t) return null;
        const r = parseInt(t.getAttribute("data-pf-result-index"), 10),
      ...
      activateCurrentSelection(e) {
        ...
        const t = this.results[this.activeIndex];

        if (!t || !t.data) return;
        const i = this.getOptionsForResult(t)[this.activeOptionOffset];
      ...
      handleResults(e) {
        ...
        for (const i of this.results) i.cleanup();
        if (
          ((this.pendingNavigation = 0),
          this.clearLoadingAnnouncement(),
        ...
        const t = this.maxResults > 0 ? e.results.slice(0, this.maxResults) : e.results;

        this.resultsEl && ((this.resultsEl.innerHTML = ""), (this.selectedEl = null));
        const r = this.getResultRenderer();

        ((this.results = t.map((i, a) => {
          const l = this.getPlaceholder(),
            c = Ke(l)[0];
      ...
      buildTemplateData(e) {
        const t = this.showSubResults ? this.instance.getDisplaySubResults(e) : [],
        ...
        return {
          ...
          url: e.url || "",
          sub_results: t.map((i) => {
            const a = this.instance.generateId("pf-sb-result");
      ...
      getResultRenderer() {
        ...
        if (this.compiledResultTemplate) {
          ...
          return (t) => {
            const r = this.buildTemplateData(t);

            return e(r);
          };
        }
        return (e) => {
          const t = this.buildTemplateData(e);
        ...
        if (this.resultsEl) {
          ...
          for (let e = 0; e < this.results.length; e++) {
            ...
            if (t.data) {
              ...
              for (const l of a.slice(1)) this.resultsEl.appendChild(l);
            } else {
      ...
      announceResults() {
        ...
        if (e === 0)
          ...
          const t = e === 1 ? "one_result" : "many_results";
        ...
        (e.registerInput(this, { keyboardNavigation: !0 }),
          ...
          e.on(
            ...
            (t) => {
              ...
              this.isLoading = !1;
              const i = e.translate("error_search") || "Search failed";
