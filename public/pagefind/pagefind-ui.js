(() => {
  ...
  const U = (l, e) => {
    for (const t in e) Os(l, t, { get: e[t], enumerable: !0 });
  };
    ...
    _getObserver() {
      return (
        ...
        (this._observer = new ResizeObserver((e) => {
          for (const t of e) (l.entries.set(t.target, t), this._listeners.get(t.target)?.(t));
        }))
      );
    }
  };
  ...
  function _e(l, e, t) {
    const { fragment: s, after_update: a } = l.$$;

    (s && s.m(e, t),
      Ae(() => {
        const i = l.$$.on_mount.map(Bt).filter(ut);

        (l.$$.on_destroy ? l.$$.on_destroy.push(...i) : v(i), (l.$$.on_mount = []));
      }),
      a.forEach(Ae));
  }
  function be(l, e) {
    ...
    (ga = class extends HTMLElement {
      ...
      async connectedCallback() {
        if (((this.$$cn = !0), !this.$$c)) {
          ...
          for (const a of this.$$s) a in t && (e[a] = [l(a)]);
          for (const a of this.attributes) {
            const i = this.$$g_p(a.name);

            i in this.$$d || (this.$$d[i] = Et(i, a.value, this.$$p_d, "toProp"));
          }
          ...
          const s = () => {
            ...
            for (const a in this.$$p_d)
              if (((this.$$d[a] = this.$$c.$$.ctx[this.$$c.$$.props[a]]), this.$$p_d[a].reflect)) {
                const i = Et(a, this.$$d[a], this.$$p_d, "toAttribute");
  ...
  function D(l) {
    const e = typeof l == "string" ? l.charCodeAt(0) : l;
    ...
    if (i > 1 && i < 9) {
      if (((t.language = s.slice(0, i)), i < 4)) {
        ...
        for (
          ...
          if (n > 2)
            return r(i, 3, "Too many extended language subtags, expected at most 3 subtags");
          (t.extendedLanguageSubtags.push(s.slice(i + 1, i + 4)), (i += 4), n++);
        }
      }
      for (
        a.charCodeAt(i) === 45 &&
          ...
          a.charCodeAt(i) === 45 &&
            (D(a.charCodeAt(i + 1)) && D(a.charCodeAt(i + 2)) && !D(a.charCodeAt(i + 3))
        ...
        for (; P(a.charCodeAt(c)); ) {
          if (c - n > 7) return r(c, 1, "Too long variant, expected at most 8 characters");
          c++;
        }
      ...
      for (
        ...
        for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)) && P(a.charCodeAt(n + 2)); ) {
          ...
          for (n = C + 2, c++; P(a.charCodeAt(n)); ) {
            if (n - C > 7) return r(n, 2, "Too long extension, expected at most 8 characters");
            n++;
          }
        }
        if (!c)
          return r(n, 4, "Empty extension, extensions must have at least 2 characters of content");
        (t.extensions.push({
    ...
    if (
      ...
      for (; a.charCodeAt(n) === 45 && P(a.charCodeAt(n + 1)); ) {
        ...
        for (n = c; P(a.charCodeAt(n)); ) {
          if (n - c > 7) return r(n, 5, "Too long private-use area, expected at most 8 characters");
          n++;
        }
    ...
    return {
      c() {
        (r && r.c(),
          ...
          _(i, "class", "pagefind-ui__result-excerpt pagefind-ui__loading svelte-j9e30"),
      ...
      p(n, c) {
        n[0] ? r || ((r = ql(n)), r.c(), r.m(e.parentNode, e)) : r && (r.d(1), (r = null));
      },
      d(n) {
        (n && (B(e), B(t)), r && r.d(n));
      },
    ...
    return {
      ...
      p(a, i) {
        (i & 2 && !ce(e.src, (t = a[1].meta?.image)) && _(e, "src", t),
          i & 2 && s !== (s = a[1].meta?.image_alt || a[1].meta?.title) && _(e, "alt", s));
      },
      d(a) {
        a && B(e);
      },
  ...
  function da(l) {
    ...
    return {
      ...
      p(i, [r]) {
        s === (s = t(i, r)) && a ? a.p(i, r) : (a.d(1), (a = s(i)), a && (a.c(), a.m(e, null)));
      },
      i: W,
      o: W,
      d(i) {
  ...
  function Aa(l, e, t) {
    let { show_images: s = !0 } = e,
      ...
      c = [],
      C = (o, d) => {
        if (!o || /^[a-z][a-z0-9+.-]*:/i.test(o) || /^\/\//.test(o) || o.startsWith("/")) return o;
        try {
    ...
    return {
      c() {
        (r && r.c(),
          ...
          _(i, "class", "pagefind-ui__result-excerpt pagefind-ui__loading svelte-4xnkmf"),
      ...
      p(n, c) {
        n[0] ? r || ((r = ns(n)), r.c(), r.m(e.parentNode, e)) : r && (r.d(1), (r = null));
      },
      d(n) {
        (n && (B(e), B(t)), r && r.d(n));
      },
    ...
    return {
      ...
      p(Q, f) {
        if (
          ...
          Q[4] ? (o ? o.p(Q, f) : ((o = os(Q)), o.c(), o.m(t, C))) : o && (o.d(1), (o = null)),
          f & 8)
        ) {
          d = S(Q[3]);
          let p;
  ...
  function us(l) {
    ...
    return {
      ...
      m(u, A) {
        (x(u, e, A), m(e, t), m(t, s), m(s, i), m(e, n), m(e, c), (c.innerHTML = C));
      },
      p(u, A) {
  ...
  const Lt = class extends T {
      constructor(e) {
        (super(), K(this, e, ma, Qa, O, { show_images: 0, process_result: 6, result: 7 }));
      }
    },
    As = Lt;
  ...
  function Qs(l) {
    ...
    return {
      ...
      p(c, C) {
        if ((C & 112 && s !== (s = `${c[4]("filters_label", c[5], c[6])}`) && H(a, s), C & 143)) {
    ...
    return {
      c() {
        ((e = F("div")),
          ...
          w(e, "pagefind-ui__filter-value--checked", l[0][`${l[10]}:${l[14]}`]));
      },
      m(h, y) {
        (x(h, e, y),
          m(e, t),
      ...
      p(h, y) {
        ((l = h),
          ...
          y & 3 && w(e, "pagefind-ui__filter-value--checked", l[0][`${l[10]}:${l[14]}`]));
      },
      d(h) {
        (h && B(e), (Q = !1), f());
      },
  ...
  function Fs(l) {
    ...
    return {
      ...
      p(d, g) {
        if (
          (g & 2 && s !== (s = `${d[10].replace(/^(\w)/, ps)}`) && (t.innerHTML = s),
        ...
        g & 138 && u !== (u = d[7] || d[3].map(Bs).includes(d[10].toLowerCase())) && (e.open = u);
      },
      d(d) {
        (d && B(e), $(o, d));
      },
      ...
      Ce.push(() => Ol(e, "selected_filters", a)),
      {
        ...
        p(r, n) {
          ...
          (n[0] & 32 && (c.show_empty_filters = r[5]),
            ...
            !t && n[0] & 1 && ((t = !0), (c.selected_filters = r[0]), Yl(() => (t = !1))),
            e.$set(c));
        },
        i(r) {
  ...
  function Zc(l) {
    ...
    function C(I, Q) {
      return I[13].results.length === 0 ? kc : I[13].results.length === 1 ? Gc : Ec;
    }
    let u = C(l, [-1, -1]),
      A = u(l),
    ...
    return {
      ...
      p(I, Q) {
        (u === (u = C(I, Q)) && A ? A.p(I, Q) : (A.d(1), (A = u(I)), A && (A.c(), A.m(e, null))),
          Q[0] & 139292 &&
  ...
  function Ec(l) {
    let e = `${l[20]("many_results", l[19], l[7])
        ...
        a[0] & 598144 &&
          e !==
            (e = `${s[20]("many_results", s[19], s[7])
              ...
              .replace(
                /\[COUNT\]/,
                new Intl.NumberFormat(s[7].language || s[19].language).format(s[13].results.length)
              )}`) &&
          H(t, e);
      },
      d(s) {
  ...
  function Gc(l) {
    let e = `${l[20]("one_result", l[19], l[7])
        .replace(/\[SEARCH_TERM\]/, l[16])
  ...
  function Es(l) {
    ...
    return {
      ...
      p(r, n) {
        n[0] & 524416 && t !== (t = `${r[20]("load_more", r[19], r[7])}`) && H(s, t);
      },
      d(r) {
        (r && B(e), (a = !1), i());
      },
  ...
  function Gs(l) {
    ...
    return {
      c() {
        ((e = F("p")), (s = Z(t)), _(e, "class", "pagefind-ui__message svelte-e9gkc3"));
      },
      m(a, i) {
        (x(a, e, i), m(e, s));
      },
  ...
  function Hc(l) {
    ...
    return {
      ...
      p(h, y) {
        ((!g || (y[0] & 524416 && a !== (a = h[20]("placeholder", h[19], h[7])))) &&
          _(s, "placeholder", a),
          (!g || (y[0] & 524416 && i !== (i = h[20]("placeholder", h[19], h[7])))) &&
            _(s, "title", i),
          (!g || y[0] & 256) && (s.autofocus = h[8]),
          y[0] & 512 && s.value !== h[9] && ge(s, h[9]),
          (!g || y[0] & 524416) && c !== (c = `${h[20]("clear_search", h[19], h[7])}`) && H(C, c),
          ...
          (!g || (y[0] & 524416 && d !== (d = h[20]("search_label", h[19], h[7])))) &&
            _(t, "aria-label", d),
      ...
      d(h) {
        (h && B(e), l[35](null), l[36](null), f && f.d(), p && p.d(), (I = !1), v(Q));
      },
    };
  }
  ...
  function Sc(l, e, t) {
    ...
    for (let b = 0; b < a.length; b++) s[a[b]] = { language: a[b], ...hs[b].strings };
    let { base_path: i = "/pagefind/" } = e,
      ...
      kl = (b) => {
        ...
        const E = document.activeElement,
          L = E && (E.tagName === "INPUT" || E.tagName === "TEXTAREA" || E.isContentEditable);

        b.key === "/" && !L && (b.preventDefault(), J?.focus());
      };

    (Ut(() => {
      const b = document?.querySelector?.("html")?.getAttribute?.("lang") || "en",
      ...
      yt(() => {
        (G?.destroy?.(), (G = null), q && document.removeEventListener("keydown", kl));
      }));
    let Ll = async () => {
        if (!mt && (t(12, (mt = !0)), !G)) {
          let b;
...
`)
      ...
      Hs = async () => {
        G && ((El = await G.filters()), (!Ie || !Object.keys(Ie).length) && t(18, (Ie = El)));
      },
      Rs = (b) => {
        const E = {};
      ...
      vs = (b) => {
        (b.key === "Escape" && (t(9, (R = "")), J.blur()), b.key === "Enter" && b.preventDefault());
      };
  ...
  const Qt = class {
    ...
    triggerFilters(e) {
      ...
      for (const [s, a] of Object.entries(e))
        if (Array.isArray(a)) for (const i of a) t[`${s}:${i}`] = !0;
        else t[`${s}:${a}`] = !0;
