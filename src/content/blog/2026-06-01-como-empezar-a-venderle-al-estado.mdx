...
description: >-
  Una guía paso a paso para que las pequeñas y medianas empresas entiendan cómo ingresar al mercado de las compras públicas.
...
<TestimonialSection
  paddingVertical="sm"
  text="El primer contrato estatal que ganamos cambió el rumbo de nuestra empresa. Nos dio la estabilidad financiera necesaria para contratar más personal y mejorar nuestra infraestructura tecnológica."
...
<CtaCenter
  heading="¿Quieres que evaluemos tu perfil para licitar?"
  subtext="Agenda una sesión de diagnóstico gratuita con uno de nuestros consultores expertos."
  buttonSections={[{ _component: "building-blocks/core-elements/button", text: "Solicitar Diagnóstico", variant: "primary", size: "md", link: "/#contacto" }]}
  colorScheme="dark"
